    ...
    <ul class="nav-list">
     ...
     <li>
       <a href="#">
         ...
         <span class="links_name">Quản lý sinh viên</span>
       </a>
       <span class="tooltip">Quản lý sinh viên</span>
     </li>
     <li>
       <a href="#">
         <i class='bx bxs-user-pin'></i>
         <span class="links_name">Quản lý giáo viên</span>
       </a>
       <span class="tooltip">Quản lý giáo viên</span>
     </li>
     <li>
       <a href="#">
         <i class='bx bx-folder'></i>
         <span class="links_name">Quản lý lớp</span>
       </a>
       <span class="tooltip">Quản lý lớp</span>
     </li>
     <li>
       <a href="{{route('mon')}}">
         <i class='bx bx-folder'></i>
